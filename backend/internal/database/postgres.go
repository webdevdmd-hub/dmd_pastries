...
func VerifySchema(db *gorm.DB) error {
	requiredTables := []string{
		...
		"payment_methods",
		"payment_accounts",
		"payment_method_account_mappings",
		"account_transfers",
	...
	requiredColumns := map[string][]string{
		...
		"products":                           {"image_file_id", "is_sellable", "is_purchasable"},
		...
		"payment_method_account_mappings": {"branch_id", "payment_method_id", "payment_account_id", "status", "deleted_at"},
