...
func (h *Handler) List(c *gin.Context) {
	...
	respond(c, "packaging items fetched successfully", result, err)
}
...
func (h *Handler) Lookup(c *gin.Context) {
	...
	respond(c, "packaging lookup fetched successfully", result, err)
}

func (h *Handler) Create(c *gin.Context) {
	var req CreatePackagingRequest
	if !bind(c, &req) {
		return
	}
	result, err := h.service.Create(utils.MustAuthContext(c), req, c.ClientIP(), c.Request.UserAgent())
	respondCreated(c, "packaging item created successfully", result, err)
}
...
func (h *Handler) Get(c *gin.Context) {
	...
	respond(c, "packaging item fetched successfully", result, err)
}
...
func (h *Handler) Update(c *gin.Context) {
	...
	respond(c, "packaging item updated successfully", result, err)
}
...
func (h *Handler) UpdateStatus(c *gin.Context) {
	...
	respond(c, "packaging status updated successfully", result, err)
}
...
func (h *Handler) Delete(c *gin.Context) {
	...
	respond(c, "packaging item deleted successfully", gin.H{"deleted": true}, err)
}

func (h *Handler) ListProductRules(c *gin.Context) {
	if !validParam(c, "productId") {
		return
	}
	result, err := h.service.ListProductRules(utils.MustAuthContext(c), c.Param("productId"))
	respond(c, "product packaging rules fetched successfully", result, err)
}

func (h *Handler) CreateProductRule(c *gin.Context) {
	if !validParam(c, "productId") {
		return
	}
	var req CreateUsageRuleRequest
	if !bind(c, &req) {
		return
	}
	result, err := h.service.CreateProductRule(utils.MustAuthContext(c), c.Param("productId"), req, c.ClientIP(), c.Request.UserAgent())
	respondCreated(c, "packaging usage rule created successfully", result, err)
}

func (h *Handler) DeleteProductRule(c *gin.Context) {
	if !validParam(c, "productId") || !validParam(c, "ruleId") {
		return
	}
	err := h.service.DeleteProductRule(utils.MustAuthContext(c), c.Param("productId"), c.Param("ruleId"), c.ClientIP(), c.Request.UserAgent())
	respond(c, "packaging usage rule deleted successfully", gin.H{"deleted": true}, err)
}
...
func parseListQuery(c *gin.Context) ListQuery {
	...
	return ListQuery{
		...
		PackagingCategoryID: c.Query("packaging_category_id"),
