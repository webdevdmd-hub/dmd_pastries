...
func DefaultSeeds() []Seed {
	return []Seed{
		...
		{ModuleName: "sales_returns", PermissionKey: "sales_returns.post", Description: "Post sales returns"},
		{ModuleName: "sales_returns", PermissionKey: "sales_returns.cancel", Description: "Cancel draft sales returns"},
		{ModuleName: "sales_returns", PermissionKey: "sales_returns.refund", Description: "Refund posted sales returns"},
		{ModuleName: "sales_returns", PermissionKey: "sales_returns.manage", Description: "Manage sales returns"},
		...
		{ModuleName: "purchasing", PermissionKey: "purchasing.returns.view", Description: "View purchase returns and vendor credits"},
		{ModuleName: "purchasing", PermissionKey: "purchasing.returns.create", Description: "Create purchase returns and vendor credits"},
		{ModuleName: "purchasing", PermissionKey: "purchasing.returns.edit", Description: "Edit draft purchase returns and vendor credits"},
		{ModuleName: "purchasing", PermissionKey: "purchasing.returns.post", Description: "Post purchase returns and vendor credits"},
		{ModuleName: "purchasing", PermissionKey: "purchasing.returns.cancel", Description: "Cancel draft purchase returns and vendor credits"},
		{ModuleName: "purchasing", PermissionKey: "purchasing.returns.manage", Description: "Manage purchase returns and vendor credits"},
		...
		{ModuleName: "expenses", PermissionKey: "expenses.delete", Description: "Hard delete expenses"},
		{ModuleName: "expenses", PermissionKey: "expenses.manage", Description: "Manage expenses"},
