...
import { useDeliveryVsPickupReport } from "@/hooks/use-bakery-orders-reports";
import { useBranchScope } from "@/hooks/use-branch-scope";
import { usePermission } from "@/hooks/use-permission";
import { useReportBranches } from "@/hooks/use-reports";
import { getErrorMessage } from "@/lib/api/client";

export function DeliveryVsPickupPageClient(): JSX.Element {
  ...
  const reportQuery = useDeliveryVsPickupReport(filters, canView && hasScope);
  ...
  return (
    <div className="mx-auto flex max-w-7xl flex-col gap-6">
      ...
      />
      <DeliveryVsPickupSummary report={reportQuery.data} />
      {reportQuery.error ? (
