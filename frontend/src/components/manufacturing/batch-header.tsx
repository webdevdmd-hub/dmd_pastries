...
import { canProduceBatch, canRecordBatchWastage } from "@/lib/manufacturing/batch-status";
...
export function BatchHeader({
  ...
  const canShowWastageAction = canRecordWastage && canRecordBatchWastage(batch);
