...
import { useProductionScheduleReport } from "@/hooks/use-bakery-orders-reports";
...
export function ProductionSchedulePageClient(): JSX.Element {
  ...
  const reportQuery = useProductionScheduleReport(filters, canView && hasScope);
        ...
        <CardContent className="p-5">
          {reportQuery.data && reportQuery.data.length > 0 ? (
            ...
            <BakeryOrdersReportEmptyState
              ...
              message="No production schedule rows in this period."
              noun="production schedule rows"
