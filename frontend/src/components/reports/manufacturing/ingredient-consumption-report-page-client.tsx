...
import { IngredientConsumptionTable } from "@/components/reports/manufacturing/ingredient-consumption-table";
...
import { useIngredientConsumptionReport } from "@/hooks/use-manufacturing-reports";
