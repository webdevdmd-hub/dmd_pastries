    ...
    <div className="space-y-6">
      <section className="border-b border-stone-300 pb-6">
        ...
        <div className="mt-2 flex flex-col gap-3 lg:flex-row lg:items-end lg:justify-between">
          ...
          <span className="w-fit rounded-md bg-[#1f2933] px-3 py-2 text-sm font-medium text-white">
      ...
      <div className="grid gap-4 lg:grid-cols-3">
        {phaseCards.map((card) => (
          <Card className="border-stone-300 shadow-none" key={card.title}>
            <CardHeader className="space-y-3">
              <div className="flex items-center justify-between gap-3">
                ...
                <span className="rounded-md border border-stone-300 px-2 py-1 text-xs font-medium text-stone-600">
                  {card.status}
                </span>
              </div>
