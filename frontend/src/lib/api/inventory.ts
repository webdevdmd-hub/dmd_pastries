...
function parseStockMovement(value: unknown): StockMovement {
  ...
  return {
    ...
    createdByUserName: stringValue(
      value.created_by_name,
      stringValue(value.created_by_user_name, "System"),
    ),
    createdAt: stringValue(value.created_at),
  };
}
...
function parseExpiryBatch(value: unknown): ExpiryBatch {
  ...
  return {
    ...
    productType: isProductType(value.product_type) ? value.product_type : null,
    categoryName: nullableString(value.category_name),
    stockLocationName: nullableString(value.stock_location_name),
    supplierName: nullableString(value.supplier_name),
    purchaseReferenceNumber: nullableString(value.purchase_reference_number),
